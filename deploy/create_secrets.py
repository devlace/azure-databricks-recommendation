...
def main():
    ...
    create_or_update_secret(api_url, token, scope, secret_name="storage_account", secret_value=blob_storage_account)
    create_or_update_secret(api_url, token, scope, secret_name="storage_key", secret_value=blob_storage_key)
